// formGenerator.js - Improved version
...
class FormGenerator {
    constructor(config, containerId) {
        ...
        this.formData = {};
        this.tableName = 'simple_form'; // Using consistent table name
    }
    ...
    async submitFormData() {
        try {
            ...
            // Try-catch for Supabase operation
            try {
                ...
                this.showNotification('Database error: ' + supabaseError.message, 'error');
            }
